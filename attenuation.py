...
class Attenuator(object):
    ...
    def __init__(self, dust_type = dust_type):
        self.dustcurve = getattr(attenuation, dust_type, None)
        #self.dust_dist = 

    def attenuate_spectrum(self, wave, spec, pars):
...
class MilkyWay(FMcurve):
    """R dependent MW curves from Fitzpatrick 1999"""
