...
class Padova2007(ModelLibrary):
    ...
    def load_all_isoc(self):
        """Globs the contents of the isochrone directory and feeds the metallicity list
        to load_isoc"""
    ...
    def load_isoc(self, Zlist):
        """reads each isochrone in sequence to produce a single structured array of
        all stellar parameters, and store those in the pars attribute."""
        self.max_mass=[]
        self.logage_list = []
    ...
    def load_one_isoc(self, Z): 
        ...
        and use it to produce a structured array of stellar parameters"""
